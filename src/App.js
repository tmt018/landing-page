...
function App() {
  return (
    ...
    <div className="container">
      ...
      <button className="navbar-toggler navbar-dark navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">
        Menu
  ...
  <section className="bg-secondary page-section" id="team">
    <div className="container">
      <div className="row">
        <div className="col-lg-12 text-center">
          <h1 className="section-heading text-uppercase">Our Awesome Team</h1> 
      ...
      <div className="row">
        <div className="col-sm-4">
          <div className="team-member">
            <h3>Daniel Lopez</h3>
            <p className="text-dark">Creative Director</p>
        ...
        <div className="col-sm-4">
          <div className="team-member">
            <h3>Cherry Lefebre</h3>
            <p className="text-dark">Marketing Specialist</p>
            <ul className="list-inline social-buttons">
              <li className="list-inline-item">
                <a href="#something">
                  <i className="fa fa-twitter"></i>
        ...
        <div className="col-sm-4">
          <div className="team-member">
            <h3>Tracey Jenkins</h3>
            <p className="text-dark">Project Manager</p>
            <ul className="list-inline social-buttons">
              <li className="list-inline-item">
                <a href="#something">
                  <i className="fa fa-twitter"></i>
